...
CREATE STAGE IF NOT EXISTS MERCEDES_PROD.RAW.USED_CAR_STAGE
    FILE_FORMAT = MERCEDES_PROD.RAW.CSV_FORMAT;


CREATE STAGE IF NOT EXISTS MERCEDES_PROD.RAW.MANUFACTURING_STAGE
    FILE_FORMAT = MERCEDES_PROD.RAW.MANUFACTURING_INFER_FORMAT;


CREATE STAGE IF NOT EXISTS MERCEDES_PROD.RAW.NHTSA_STAGE
    FILE_FORMAT = MERCEDES_PROD.RAW.NHTSA_JSON_FORMAT;
